import { AuditOutlined, BookOutlined, DashboardOutlined, FileTextOutlined, StarOutlined, TeamOutlined } from '@ant-design/icons';
      ...
      <Layout.Sider theme="light" width={200}>
        ...
        <Menu
          ...
          items={[
            ...
            { key: '/recommendations', icon: <StarOutlined />, label: <Link to="/recommendations">推荐书籍</Link> },
